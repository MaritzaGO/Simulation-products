...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { edad: @buyer.edad, identification: @buyer.identification, lastname: @buyer.lastname, name: @buyer.name, profesion: @buyer.profesion }
    end
  ...
  test "should update buyer" do
    patch :update, id: @buyer, buyer: { edad: @buyer.edad, identification: @buyer.identification, lastname: @buyer.lastname, name: @buyer.name, profesion: @buyer.profesion }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
